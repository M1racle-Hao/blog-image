...
apk="Auto_V650.601392_release_signed.apk"
cd
rm -rf A1
mkdir A1
cd A1
rm -rf  $apk
curl -o $apk https://mapdownload.autonavi.com/apps/auto/manual/V650/$apk
check=0
